...
public class EnvioJavaMailGUIComProgressBarFlutuante extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EnvioJavaMailGUIComProgressBarFlutuante frame = new EnvioJavaMailGUIComProgressBarFlutuante();
	...
	public EnvioJavaMailGUIComProgressBarFlutuante() {
		...
		btnAnexar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int returnVal = chooser.showOpenDialog(EnvioJavaMailGUIComProgressBarFlutuante.this);
